...
| 18   | Alta       | Como administrador, quero que o preço aplicado a cada serviço seja preservado no agendamento para que alterações futuras no catálogo não modifiquem os valores do histórico                                  | 3          | | Concluído (pendente de commit) |
