...
| 23   | Média      | Como administrador, quero visualizar o faturamento bruto do salão por mês para acompanhar os resultados financeiros do estabelecimento                                                                       | 5          | | Tela existe, valores sempre zerados — dependia da US 18 (agora concluída); falta reconferir se os valores já aparecem corretos |
...
| 32   | Média      | Como usuário, quero entrar com minha conta do Google para agilizar o acesso ao sistema                                                                                                                        | 2          | | Não implementado (botão sem função) |
...
| 34   | Média      | Como usuário, quero acessar as configurações da minha conta para alterar meu e-mail, senha e nome, e, caso eu seja um profissional, também minha foto de perfil, para manter meus dados atualizados          | 5          |        | Não implementado |
